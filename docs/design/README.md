...
**Related:** Admin & Employer dashboard wireframes — [admin-employer-wireframes.md](./admin-employer-wireframes.md) · [DASHBOARD-DESIGN-HANDOFF.md](./DASHBOARD-DESIGN-HANDOFF.md) · prototype routes `/wireframes`, `/admin/*`, `/employer/*`.
